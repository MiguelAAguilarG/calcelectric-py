...
if __name__ == "__main__":
    ...
    # Se procede a hacer el cálculo que se desea hacer para la carga,
    # un cálculo completo es calculo_basico, por el momento,
    # solo hay ese cálculo completo, 
    # este esta compuesto por cálculos que se encuentran en el módulo calculos.py. 
    # calculo_basico es un método en la Clase Carga
